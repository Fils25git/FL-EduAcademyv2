...
// You don't need to declare 'createClient' here again.
const supabase = supabase.createClient(SUPABASE_URL, SUPABASE_KEY); // Use the global 'supabase' object to initialize
